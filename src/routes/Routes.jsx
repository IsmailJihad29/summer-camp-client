    ...
    element: <Main />,
        ...
        children: [
            ...
            { 
              ...
              loader: ()=> fetch('https://summer-camp-server-red-three.vercel.app/instructor')
            },
            { 
              path: "/login",
              element:<Login/>
  ...
  },
  {
    ...
    children: [
      ...
      { 
        ...
        loader:({params})=> fetch(`https://summer-camp-server-red-three.vercel.app/class/${params.id}`)
      },
      {
        path: 'addclass',
      ...
      },
      {
        path: 'payment/:id',
        element: <Payment />,
        loader:({params})=> fetch(`https://summer-camp-server-red-three.vercel.app/carts/${params.id}`)
      },
      {
